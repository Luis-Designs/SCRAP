...
import { profileSelectors } from "../config/scrapperSelectors.js";
...
async function scrap() {
    ...
    console.log("ContactInfo: ", profile?.contactInfo);
    console.log("Experience:  ", profile?.experienceTitles);
    console.log("Education:  ", profile?.educationTitles);
    console.groupEnd();
}
